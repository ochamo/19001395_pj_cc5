...
namespace BillingReport
{
    public class BillingService : IBillingService
    {
        public void SendBill(BillingArgs billingArgs)
        {
            ...
            {
                MailMessage billingMail = new MailMessage("", "");
        ...
        public byte[] generateBill(BillingArgs args)
        {
            ...
            stringBuilder.AppendLine("<thead style='background-color: #D20B0C;color:#ffffff'>");
            stringBuilder.AppendLine("<tr>");
            stringBuilder.AppendLine("<td>Producto</td>");
            stringBuilder.AppendLine("<td>Cantidad</td>");
            stringBuilder.AppendLine("<td>Precio U.</td>");
            stringBuilder.AppendLine("<td>Total</td>");
            stringBuilder.AppendLine("</tr>");
